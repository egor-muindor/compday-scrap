...
Первый этап — собрать список товаров из каталога. Использует Playwright (headless-браузер), так как сайт рендерит каталог через JavaScript с hash-навигацией для фильтров.
